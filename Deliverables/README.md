...
- The **Maximum entropy** for 60 equally used experts is $\log_2(60) \approx 5.91$ bits, our measured entropy is **4.10 bits**, which is about 69% of the maximum, this further proves that usage is concentrated on few experts.

Results can be reproduce using `eval.ipynb`.
